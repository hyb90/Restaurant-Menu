...
export default class AuthService extends BaseService {
    ...
    async updateMenu(payload) {
        this.globalStateStore.loadingElements['update-menu-form'] = true;
        await this.get("/sanctum/csrf-cookie");
        return this.put("/api/menu-update/"+payload.id, payload).finally(() => {
            this.globalStateStore.loadingElements['update-menu-form'] = false;
        });
    }
