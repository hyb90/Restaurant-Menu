        ...
        const state = reactive({
            mainMenu: [
                ...
                },
                {
                    ...
                    showDesktop: true,
                    showMobile: true,
                    requiresAbility: getAbilitiesForRoute(['categories.list', 'categories.create', 'categories.edit']),
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            showDesktop: true,
                            showMobile: true,
                            requiresAbility: getAbilitiesForRoute('categories.create'),
                ...
                },
                {
                    ...
                    showDesktop: true,
                    showMobile: true,
                    requiresAbility: getAbilitiesForRoute(['items.list', 'items.create', 'items.edit']),
                    to: '/panel/items/list',
                    children: [
                        {
                            name: trans('global.phrases.all_records'),
                            ...
                            showDesktop: true,
                            showMobile: true,
                            requiresAbility: getAbilitiesForRoute('items.list'),
                            to: '/panel/items/list',
                        },
                        {
                            name: trans('global.buttons.add_new'),
                            ...
                            showDesktop: true,
                            showMobile: true,
                            requiresAbility: getAbilitiesForRoute('items.create'),
