<template>
    <Page :title="page.title" :breadcrumbs="page.breadcrumbs" :actions="page.actions" @action="onAction" :is-loading="page.loading">
        <Panel>
            <Form id="edit-item" @submit.prevent="onSubmit">
...
export default defineComponent({
    ...
    setup() {
        ...
        const page = reactive({
            id: 'edit_item',
            title: trans('global.pages.items_edit'),
            filters: false,
            loading: true,
            breadcrumbs: [
                {
                ...
                {
                    name: trans('global.pages.items_edit'),
                    active: true,
                }
            ],
            actions: [
        ...
        function onSubmit() {
            service.handleUpdate('edit-item', route.params.id, {
              name: form.name,
              price: form.price ,
